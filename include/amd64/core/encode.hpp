...
namespace amd64::core::encode
{
    ...
    template < x86reg R1, x86reg R2 > constexpr std::uint8_t rex( const bool w, R1 reg1, R2 reg2 ) noexcept
    {
    ...
    template < x86reg R1, x86reg R2 > constexpr std::uint8_t mod_rm( R1 reg, R2 rm ) noexcept
    {
